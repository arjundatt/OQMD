...
//            LookAndFeelFactory.installJideExtension(LookAndFeelFactory.OFFICE2007_STYLE);
    ...
    private void showTableView() {
        JideLabel metadataLabel = new JideLabel("Metadata Not Discovered");
        metadataLabel.setHorizontalAlignment(SwingConstants.CENTER);
        rightPanel.init("Metadata", metadataLabel);
        JideLabel tableLabel = new JideLabel("Metadata Not Discovered");
        tableLabel.setHorizontalAlignment(SwingConstants.CENTER);
        rightPanel.addTab("Data", tableLabel);
        showMetaData();
        showTableData();
    }
    ...
    private void showMetaData() {
        ...
        if (node.getAttribute("metadata_discovered").equals("true")) {
            Vector data = DatabaseUtility.getMetaData(connection, node.getParent().toString(), node.toString());
            String[] col = new String[]{"Name", "Data Type", "Size", "Decimal Digit", "Is Primary Key", "Order"};
            ...
            rightPanel.refresh("Metadata", 0, table);
        }
        rightPanel.updateUI();
    }
