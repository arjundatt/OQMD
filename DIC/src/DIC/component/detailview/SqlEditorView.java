...
public class SqlEditorView extends JPanel implements ActionListener {
    ...
    public SqlEditorView(Connection connection) {
        ...
        open = getButton("Open", "Open", KeyEvent.VK_O);
        open.addActionListener(this);
        save = getButton("Save", "Save", KeyEvent.VK_S);
        save.addActionListener(this);
        saveAs = getButton("Save As", "Save As", KeyEvent.VK_T);
        saveAs.addActionListener(this);
        cut = getButton("Cut", "Cut", KeyEvent.VK_X);
        cut.addActionListener(this);
        copy = getButton("Copy", "Copy", KeyEvent.VK_C);
        copy.addActionListener(this);
        paste = getButton("Paste", "Paste", KeyEvent.VK_V);
        paste.addActionListener(this);
        caseToggle = getButton("Case Toggle", "Case Toggle", KeyEvent.VK_T);
        caseToggle.addActionListener(this);
        execute = getButton("Execute", "Execute", KeyEvent.VK_E);
        execute.addActionListener(this);
        clearAll = getButton("Clear All", "Clear All", KeyEvent.VK_L);
        clearAll.addActionListener(this);
        history = getButton("History", "History", KeyEvent.VK_H);
        history.addActionListener(this);
        closeAllTabs = getButton("Close All", "Close All Tabs", KeyEvent.VK_TAB);
